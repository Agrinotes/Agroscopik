...
<script type="text/javascript">
    $(document).ready(function () {
        var $container4 = $('div#action_farmFertilizerMvts');
        ...
        if (index4 == 0) {
            addFertiMvt($container4);
            $("#action_farmFertilizerMvts > div > a").remove();
        } else {
...
<script type="text/javascript">
    $(document).ready(function () {
        var $container6 = $('div#action_expenses');
...
<script type="text/javascript">
    $(document).ready(function () {
        var $container7 = $('div#action_irrigations');
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#action_intervention').on('change', function () {
            if ($("#action_intervention").select2('data')[0]['text'] == "Traitement phytosanitaire") {
            ...
            } else if ($("#action_intervention").select2('data')[0]['text'] == "Fertilisation") {
                $('#density').hide("slow");
            ...
            }else if($("#action_intervention").select2('data')[0]['text'].indexOf('auxiliaire') > -1) {
                $('#density').hide("slow");
                $('#farmSpecialities').hide("slow");
                $('#harvestProducts').hide("slow");
                $('#farmFertilizers').hide("slow");
            ...
            } else if($("#action_intervention").select2('data')[0]['text'] == "Observation") {
                $('#density').hide("slow");
                $('#farmSpecialities').hide("slow");
                $('#harvestProducts').hide("slow");
                $('#farmFertilizers').hide("slow");
                ...
                $('#nbWorkers').show("slow");
                $('#periods').show("slow");
            }else if($("#action_intervention").select2('data')[0]['text'] == "Relevé de drainage") {
                $('#density').hide("slow");
                $('#farmSpecialities').hide("slow");
                $('#harvestProducts').hide("slow");
                $('#farmFertilizers').hide("slow");
