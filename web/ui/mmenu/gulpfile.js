...
gulp.task('scripts:es',         [], lazyQuire(require, './gulp/recipes/scripts/es'));
gulp.task('scripts:plugins', [], lazyQuire(require, './gulp/recipes/scripts/plugins'));
gulp.task('scripts:dev',        [], lazyQuire(require, './gulp/recipes/scripts/dev'));

gulp.task('dist-js', function(done){
  sequence('scripts:clean', 'scripts:es', 'scripts:plugins', 'scripts:dev', function(){
    done();
...
gulp.task('dist', function(done){
  sequence('dist-html','dist-css','dist-js','dist-skins',function(){
    done();
